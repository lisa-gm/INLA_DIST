...
Eigen::VectorXd eigen_pardiso(Eigen::SparseMatrix<double> A, Eigen::VectorXd f,  double log_det)
{
	 typedef Eigen::SparseMatrix<double> SpMat;
	 typedef Eigen::PardisoLDLT  <SpMat > Solver;
