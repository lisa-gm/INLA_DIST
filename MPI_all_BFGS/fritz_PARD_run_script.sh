...
export OMP_NUM_THREADS=${l1t}
echo "OMP_NUM_THREADS=${l1t}"
...
srun -n ${num_ranks} ./call_INLA ${ns} ${nt} ${nb} ${no} ${folder_path} ${solver_type} >INLA_PARDISO_test_ns${ns}_nt${nt}_nb${nb}_${num_ranks}_${l1t}_${l2t}_i1.txt 
