...
srun -n ${num_ranks} nsys profile -o nsys_output_ns${ns}_nt${nt}_${nb}_${num_ranks}_${l1t}_${l2t}_pinMem.txt --stats=true --force-overwrite true ./call_INLA ${ns} ${nt} ${nb} ${no} ${folder_path} ${solver_type} >INLA_RGF_nsys_ns${ns}_nt${nt}_nb${nb}_${num_ranks}_${l1t}_${l2t}_singleCopyV.txt
