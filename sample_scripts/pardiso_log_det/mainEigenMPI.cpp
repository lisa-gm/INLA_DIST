...
// kaust path ... 
#include "../b_INLA/read_write_functions.cpp"
...
int main(int argc, char* argv[])
{
    ...
    std::cout << "Calling PARDISP with " << threads_level2 << " threads." << std::endl;
...
/* -------------------------------------------------------------------- */    
  ...
  if (solver == 0)
  {
    ...
    /* print & save diagonal elements */
      std::string sel_inv_file_name = "sel_inv_PARDISO_ns" + ns_s + "_nt" + nt_s + "_nb" + nb_s + "_no" + no_s + ".dat"; 
