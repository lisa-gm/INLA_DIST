...
#SBATCH --job-name=call_INLA_BTA          #Your Job Name
...
folder_path=/home/hpc/ihpc/ihpc060h/b_INLA/data/${data_type}/ns${ns}_ntFit${nt_fit}_ntPred${nt_pred}_noPerTs${no_per_ts}_nss${nss}_nb${nb}
...
#srun -n ${num_ranks} ./call_INLA ${ns} ${nss} ${nt_fit} ${nt_pred} ${nt_total} ${no} ${nb} ${folder_path} ${solver_type} >output_ns${ns}_nss${nss}_ntFit${nt_fit}_ntPred${nt_pred}_nb${nb}_${solver_type}_cuda_testMSEyPred_${num_ranks}_${l1t}_${l2t}.txt #>INLA_BTA_output_ns${ns}_nt${nt}_nb${nb}_${num_ranks}_${l1t}_${l2t}_nestedOMP_singleCopyV_i1.txt
srun -n ${num_ranks} ./call_INLA ${ns} ${nss} ${nt_fit} ${nt_pred} ${nt_total} ${no_per_ts} ${nb} ${folder_path} ${solver_type} >output_ns${ns}_nss${nss}_ntFit${nt_fit}_ntPred${nt_pred}_nb${nb}_${solver_type}_cuda_${num_ranks}_${l1t}_${l2t}.txt #>INLA_BTA_output_ns${ns}_nt${nt}_nb${nb}_${num_ranks}_${l1t}_${l2t}_nestedOMP_singleCopyV_i1.txt
#mpirun -n ${num_ranks} nsys profile -o nsys_output_checkBTAinv ./call_INLA ${ns} ${nb} ${nt_fit} ${nt_pred} ${nt_total} ${no_per_ts} ${folder_path} ${solver_type} #>output_forecasting_ns${ns}_nt${nt}_nb${nb}_wNA.txt #>INLA_BTA_output_ns${ns}_nt${nt}_nb${nb}_${num_ranks}_${l1t}_${l2t}_nestedOMP_singleCopyV_i1.txt
#srun -n ${num_ranks} ./call_INLA ${ns} ${nt} ${nb} ${no} ${folder_path} ${solver_type} >INLA_BTA_output_ns${ns}_nt${nt}_nb${nb}_${num_ranks}_${l1t}_${l2t}_singleCopyV.txt
